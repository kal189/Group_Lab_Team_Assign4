...
public class ManageFacultyJPanel extends javax.swing.JPanel {
   ...
   String searchType = (String) cmbSearchType.getSelectedItem();
    ...
    for (EmployeeProfile faculty : business.getEmployeeDirectory().getEmployeeList()) {
        ...
        String personName = faculty.getPerson().getName();
        ...
        if (match) {
            ...
            row[2] = faculty.getPerson().getDepartment();
    ...
    if (selectedRow == -1) {
        javax.swing.JOptionPane.showMessageDialog(this,
            "Please select a faculty member to view!",
            "No Selection",
    ...
    EmployeeProfile faculty = business.getEmployeeDirectory().findEmployee(facultyId);
    
    if (faculty != null) {
        FacultyDetailsJPanel detailsPanel = new FacultyDetailsJPanel(business, CardSequencePanel, faculty, this);
        CardSequencePanel.add("FacultyDetails", detailsPanel);
