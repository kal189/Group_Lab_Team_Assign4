...
public class FacultyWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public FacultyWorkAreaJPanel(Business b, EmployeeProfile fp, JPanel clp) {
        ...
        jLabel1.setText("Welcome, " + fp.getPerson().getName());
    ...
    ManageCoursesJPanel coursesPanel = new ManageCoursesJPanel(business, facultyProfile, CardSequencePanel);
    CardSequencePanel.add("ManageCourses", coursesPanel);
    ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);

    }//GEN-LAST:event_jButton4IdentifyResourceAssetsActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ManageStudentGradesJPanel gradesPanel = new ManageStudentGradesJPanel(business, facultyProfile, CardSequencePanel);
    CardSequencePanel.add("ManageGrades", gradesPanel);
    ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    ...
    private void jButton6IdentifyEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6IdentifyEventsActionPerformed
            FacultyProfileJPanel profilePanel = new FacultyProfileJPanel(business, facultyProfile, CardSequencePanel);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        PerformanceReportsJPanel reportsPanel = new PerformanceReportsJPanel(business, facultyProfile, CardSequencePanel);
