...
public class ProfileWorkAreaMainFrame extends javax.swing.JFrame {
    ...
    // Cast to EmployeeProfile to access methods
    EmployeeProfile emp = (EmployeeProfile) profile;
    
    // Get the Person ID to distinguish Admin from Faculty
    String personId = emp.getPerson().getPersonId();
    
    // Check if Faculty (ID starts with "F")
    if (personId.startsWith("F")) {
        // It's a faculty member!
        facultyworkarea = new FacultyWorkAreaJPanel(business, emp, CardSequencePanel);
        CardSequencePanel.removeAll();
        CardSequencePanel.add("faculty", facultyworkarea);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    } 
    // Check if Admin (ID starts with "A")
    else if (personId.startsWith("A")) {
        // It's an admin!
